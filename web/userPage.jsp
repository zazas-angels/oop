    ...
    <script type="text/javascript">
        ...
        function createCommentBox() {
            ...
            div.innerHTML += ' <div class="drsElement"'
                    ...
                    + numElements
                    + ')" '
                    + 'value="გაშვება"  style="background: blue; width:60px">'
                    + '	</form>'
...
<div id="control" style="position: fixed;">
    ...
    <option
        ...
        სვეტები
    <option
            value="http://www.unsigneddesign.com/Seamless_background_textures/thumbs/seamlesstexture21_1200.jpg">
        ნაცრისფერი
        ბაზისი
    ...
    <option
            value="http://1.bp.blogspot.com/_JR1wtGyGotU/S8U_5R3ktHI/AAAAAAAAAo8/iDlD4cK2D6A/s1600/Perfectly+Pink+2.gif">
        ვარდისფერობა
